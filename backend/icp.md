...
## The person
The one who owns the people problem:
- Founder / CEO / MD (at sub-80 headcount, they still own it directly)
- COO (attrition of a key person is delivery risk = their problem)
- Head of People / People & Culture / HR Director / CHRO / CPO (80+ headcount)

## Disqualify
- Enterprises (500+, procurement-led buying)
- Companies under ~15 heads (no signal to analyse, no budget)
- HR-tech vendors (competitors)
- Recruiting agencies / staffing firms (Workenvo is not an ATS)
- Anyone already on the contacted list (check-contacted handles this)

## Hook material to look for (opener fuel, NOT gates)
Any ONE true, recent, specific thing:
- A batch of open job postings ("hiring 8 roles" = a scaling moment)
- A new office / expansion / regional launch
...
## ICP-health self-score (report at end of every run)
Rate 1–10 how easy it was to find a fresh, well-fitting prospect with a real hook this run (10 = abundant, ≤4 = scraping). One sentence why. Three runs at ≤4 = this ICP file needs widening.
